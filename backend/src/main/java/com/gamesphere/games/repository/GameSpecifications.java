...
public final class GameSpecifications {
    ...
    public static Specification<Game> genre(String value) { return jsonArrayContains("genres", value); }
    public static Specification<Game> platform(String value) { return jsonArrayContains("platforms", value); }
    public static Specification<Game> tag(String value) { return jsonArrayContains("tags", value); }
    ...
    private static Specification<Game> jsonArrayContains(String field, String value) {
        return (root, query, cb) -> {
            ...
            return cb.like(root.get(field).as(String.class), "%\"" + value.trim() + "\"%");
        };
    }

    public static Specification<Game> releaseYear(Integer year) {
        return (root, query, cb) -> year == null ? cb.conjunction() : cb.equal(root.get("releaseYear"), year);
    }
    public static Specification<Game> minRating(BigDecimal value) {
        return (root, query, cb) -> value == null ? cb.conjunction() : cb.greaterThanOrEqualTo(root.get("rating"), value);
    }
    public static Specification<Game> maxRating(BigDecimal value) {
        return (root, query, cb) -> value == null ? cb.conjunction() : cb.lessThanOrEqualTo(root.get("rating"), value);
    }
    public static Specification<Game> minPrice(BigDecimal value) {
        return (root, query, cb) -> value == null ? cb.conjunction() : cb.greaterThanOrEqualTo(root.get("price"), value);
    }
    public static Specification<Game> maxPrice(BigDecimal value) {
        return (root, query, cb) -> value == null ? cb.conjunction() : cb.lessThanOrEqualTo(root.get("price"), value);
    }
    ...
    public static Specification<Game> releaseDateBefore(LocalDate date) {
        return (root, query, cb) -> date == null ? cb.conjunction() : cb.lessThanOrEqualTo(root.get("releaseDate"), date);
    }
